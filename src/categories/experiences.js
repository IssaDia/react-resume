    ...
    render() 
        {
            return(
                ...
                <div>
                    ...
                    <p>BUSINESS et DECISION (Lyon) | Juillet 2019 - Septembre 2019</p>
                    <p>J’ai eu l’opportunité d’intégrer cette société et d’effectuer une montée en compétences sur le CMS Magento. 
                ...
                <div>
                    <h5>Développeur web</h5>
                    <p>IDO DATA (Vlleurbanne) | Janvier 2019 - Avril 2019</p>
                    <p>J'ai effectué mon stage de fin de formation au sein de cette start-up durant lequel ma mission était de créer un espace client 
                ...
                <div>
                    ...
                    <p>BUSINESS et DECISION (Lyon) | Juillet 2019 - Septembre 2019</p>
                    <p>J'étais au sein d'une équipe au siége du groupe chargé de la gestion de la paie d'environ 2000 intérimaires. J'avais aussi des missions 
